...
app.layout = html.Div([
    html.H1(
        'Santiago Le Jeune, Federico Amato Trading Strategy',
        style={'display': 'block', 'text-align': 'center'}
    ),
    html.Div([
        html.H2('Strategy outlook'),
        html.P('This app explores a simple trading strategy that exploits the negative relationship '+\
               'between the bond yield curve and the stock market '+\
    ...
    html.Div([
        ...
        html.Ol([
            ...
            html.Li(
                'CI: confidence interval for estimating LB & UB of predicted yield. ' + \
                'Written as a numerical value (eg. 0.6 = 60%).'
            ),
            html.Li(
                'rho: Maximum value of correlation between stock and bond yields allowed.' + \
                'If the correlation between the two is > rho, trades are not allowed to be performed.'
            ),
            html.Li(
                    ...
                    [
                        ...
                        html.Table(
                            [html.Tr([
                                ...
                                html.Td(html.Div(id='strategy-annual_return')),
                        ...
                        html.Table(
                            ...
                            [html.Tr([
                                ...
                                html.Th('n'), html.Th('N'), html.Th('alpha'), html.Th('rho'), html.Th('CI'),
                                html.Th('Lot Size'),
...
@app.callback(
    ...
    [dash.dependencies.Input('ivv-hist', 'children'),
     ...
     dash.dependencies.Input('rho', 'value'),
     dash.dependencies.Input('CI', 'value'),
...
@app.callback(
    [
        ...
        dash.dependencies.Output('strategy-annual_return', 'children'),
...
def update_performance_metrics(trade_ledger):
    ...
    annual_return = round(gmrr*avg_trades_per_yr,3)
    ...
    annual_return = str(round(gmrr*avg_trades_per_yr,3)/100) + '%'

    vol_str = str(round(vol, 3)) + "% / trade"

    return fig, alpha, beta, gmrr_str, avg_trades_per_yr, annual_return, vol_str, sharpe
